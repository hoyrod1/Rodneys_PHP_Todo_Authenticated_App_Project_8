    ...
    <div class="col-container">
        ...
        <ul class="nav">
          <?php if (is_authenticated()) : ?>
              <!-- BEGINNING OF NON-MEMBERS-AREA -->
              <li class="nav-item task<?php if ($page == "account") { echo " on"; } ?>"><a class="nav-link" href="account.php">My Account</a></li>
              <li class="nav-item tasks"><a class="nav-link" href="inc/do_logout.php">Logout</a></li>
              <!-- ENDING OF MEMBERS-AREA -->
          <?php else: ?>    
              <!-- BEGINNING OF NON-MEMBERS-AREA -->
